 ...
 class Solution10 {
    public static void main(String[] args) throws IOException {
        ...
        try (InputStream stream = System.in;
            ...
            Path road = Path.of(way);
            Files.write(road,bytes);
...
Он написал программу, которая считывает из консоли путь к файлу и записывает в этот файл последовательность байтов,
