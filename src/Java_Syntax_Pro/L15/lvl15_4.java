    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.printf(INTEGER_REQUIRED);
...
* "Нужно ввести целое число", а блок catch для ArrayIndexOutOfBoundsException должен выводить сообщение: "Студента с таким номером не существует".
